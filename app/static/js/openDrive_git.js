...
function main() {
	...
	var map = new Map(scene, "../static/data/Crossing8Course.xodr");

	var maps = {
		Crossing8Course: '../static/data/Crossing8Course.xodr',
		CrossingComplex8Course: '../static/data/CrossingComplex8Course.xodr',
		Roundabout8Course: '../static/data/Roundabout8Course.xodr',
		Country: '../static/data/Country.xodr',
	}
